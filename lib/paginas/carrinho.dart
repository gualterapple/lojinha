...
import 'package:lojinha/widgets/lista_carrinho.dart';
      ...
      bottomNavigationBar: Container(
        ...
        child: Row(
          ...
          children: [
            ...
            Text('$valorTotal', style: Theme.of(context).textTheme.headline5)
          ],
        ),
      ),
    ...
    if(Inicio.itensCarrinho.isNotEmpty)
      {
        ...
        .map((item) => item.movel!.preco! * item.quantidade!.toInt())
        .reduce((precoActual, precoNovo) => precoActual + precoNovo);
      }
